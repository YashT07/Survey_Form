...
export default class SurveyQuestion5 extends Component{
    ...
    render(){
        ...
        return(
            <div style={{padding:40}}>
                <form>
                    <p>{values.firstName}, during this COVID situation, do you like if we provide homedelivery service for the food ?</p>
